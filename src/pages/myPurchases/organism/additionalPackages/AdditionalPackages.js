...
class AdditionalPackages extends React.PureComponent {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div id="accordionAdditionalPackages" className="accordion">
        <div>
          {packages &&
            packages.length &&
            packages.map(p => {
              if (p.packageType.toLowerCase() !== "additional") {
                return;
              }
              return (
                <Fragment key={p._id}>
                  ...
                  <div
                    ...
                    data-parent="#accordionAdditionalPackages"
                  >
                    ...
                    <div>
                      <div className="row">
                        ...
                        {/* <div className="col-12">
                          <p className="text-center">
                            [*Show guest names with a checkbox]
                          </p>
                        </div> */}
                      ...
                      <div className="row text-center mt-3">
                        ...
                        {/* <div className="col-12">
                          If guests name selected then show below button{" "}
                        </div>
                        <div className="col-12">
