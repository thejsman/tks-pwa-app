  ...
  wishSection() {
    ...
    return (
      <div>
        ...
        <div className="text-center sagan_container">
          <h5 className="text-white my-1 appBodyFontFamily pt-3">
            Pay Shagan Digitally
          </h5>
          <div className="BtnCommon responsiveBtn rsvpWeddingGuestName my-4">
            <div>
