  ...
  render() {
    ...
    function selectIndex(index) {
      if (results.length >= index + 1) {
        ...
        depair.val(results[index].airportIATA);
        clearResults()
      }
    }
    ...
    return (
      <div className="form-group">
        <label htmlFor={this.props.name}>Departure Airport</label>
        <input className="form-control form-control-color appBodyFontFamily appBodyFontColor" type="text" id="autocomplete2" autoComplete="off" placeholder="For example: Delhi, Mumbai" />
        <input name={this.props.name} id="airportIATA" type="hidden" />
      </div>
    )
  }
}
