    ...
    return (
      <div className="booked-ticket">
                ...
                return (
                  <button
                    className={`btn btn-default btn-responsive ankur appBodyFontFamily appBodyFontColor ${
                      guest.guestId === this.state.currentGuestId
                        ? "active"
                        : ""
                    }`}
                    key={guest.guestId}
        ...
        <div className="already-booked">
          {empList ? "" : <div className="page-title">Booked Tickets</div>}
          <div className="ticket-list">
            {guestFlights &&
              guestFlights.map(a => {
                return (
                  <Ticket tickets={a} onDelete={this.onDelete.bind(this)} />
                );
              })}
          </div>
        </div>
  ...
  render() {
    ...
    return (
      <div className="ticket appGradientColor appBodyFontColor">
        ...
        <div className="airline">{flights.airline}</div>
        ...
        <div
          className="appBodyFontColor text-center mobileBtnBridge appBodyFontFamily flex-center"
          onClick={this.deleteFlight.bind(this)}
        >
          Delete
        </div>
      </div>
