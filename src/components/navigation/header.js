          ...
          >
                        ...
                        appdet.basicDetails.eventType === "wedding" && (
                          ...
                          >
                            <div className="expMenudiv">
                              ...
                              <p className="menuName text-uppercase">
                                Our Story
                              </p>
                            </div>
                          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="expMenudiv">
                        ...
                        <p className="menuName text-uppercase">Venue</p>
                      </div>
                    </li>
                  );
                }
                  ...
                  return (
                    ...
                    >
                      <div className="expMenudiv">
                        ...
                        <p className="menuName text-uppercase">Program</p>
                      </div>
                    </li>
                  );
                }
            ...
            <li onClick={this.toggleHidden.bind(this)} data-menu="eventDetails">
              <div className="expMenudiv">
                ...
                <p className="menuName text-uppercase">Celebrations</p>
              </div>
            </li>
            {appdet &&
              appdet.appDetails &&
